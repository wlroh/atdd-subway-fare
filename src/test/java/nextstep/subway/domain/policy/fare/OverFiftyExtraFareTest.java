...
class OverFiftyExtraFareTest {
    ...
    void support(int distance, boolean expected) {
        ...
        assertThat(overFiftyExtraFare.supports(fareCondition)).isEqualTo(expected);
    }
    ...
    void fare(int distance, int expected) {
        ...
        assertAll(() -> {
            assertThat(overFiftyExtraFare.supports(fareCondition)).isTrue();
            assertThat(overFiftyExtraFare.fare(fareCondition)).isEqualTo(expected);
        });
    }
