...
class FareManagerTest extends FarePolicyLoaderTest {
    ...
    void fare(int distance) {
        ...
        assertThat(FareManager.fare(fareCondition)).isEqualTo(1_250);
    }
    ...
    void fare_extra(int distance, int expected) {
        ...
        assertThat(FareManager.fare(fareCondition)).isEqualTo(expected);
    }
    ...
    void fare_extra_lines(int distance) {
        ...
        assertThat(FareManager.fare(fareCondition)).isEqualTo(2_150);
    }
}