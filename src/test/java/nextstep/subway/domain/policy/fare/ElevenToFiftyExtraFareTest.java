...
class ElevenToFiftyExtraFareTest {
    ...
    void support(int distance, boolean expected) {
        ...
        assertThat(elevenToFiftyExtraFare.supports(fareCondition)).isEqualTo(expected);
    }
    ...
    void fare(int distance, int expected) {
        ...
        assertAll(() -> {
            assertThat(elevenToFiftyExtraFare.supports(fareCondition)).isTrue();
            assertThat(elevenToFiftyExtraFare.fare(fareCondition)).isEqualTo(expected);
        });
    }
}